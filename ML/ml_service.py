"""
HealthBridge v2 — Flask Inference Service
==========================================
Loads the *entire* fitted sklearn Pipeline (healthbridge_pipeline_v2.joblib)
...
def _load_artefacts():
    ...
    pipeline_path  = os.path.join(MODEL_DIR, "healthbridge_pipeline_v2.joblib")
...
if __name__ == "__main__":
    # Cloud platforms usually inject PORT; keep ML_SERVICE_PORT for local/dev overrides.
    port = int(os.getenv("ML_SERVICE_PORT", os.getenv("PORT", 5001)))
    print(f"[OK] Starting HealthBridge ML Service v2 on port {port}")
