    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-teal-50 via-cyan-50 to-blue-50 p-6 md:p-10">
            ...
            <main className="max-w-4xl mx-auto space-y-6">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                    <h3 className="font-bold text-gray-800 mb-4 flex items-center gap-2">
                        <Shield className="w-5 h-5 text-purple-500" /> Medical Conditions (Optional)
                    </h3>
                    ...
                    <div className="flex gap-3 mb-4">
                        <input
                            ...
                            className="flex-1 px-4 py-3 bg-gray-50 rounded-xl border-none focus:ring-2 focus:ring-purple-200 outline-none"
                        />
                        <button
                    ...
                    <div className="flex flex-wrap gap-2">
                        {conditions.map(cond => (
                            <div
                                key={cond}
                                className="flex items-center gap-2 bg-purple-50 text-purple-800 px-3 py-1.5 rounded-lg border border-purple-200"
                            >
                                <span className="text-sm">{cond}</span>
                                <button onClick={() => removeCondition(cond)} className="text-purple-400 hover:text-red-500">
