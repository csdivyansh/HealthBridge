    ...
    useEffect(() => {
        ...
        const initializeCall = async () => {
            try {
                ...
                setCall(videoCall);
                setStage('preview');
                console.log('✅ Video call ready:', callId);
                ...
                <div className="max-w-lg w-full">
                    ...
                    <div className="bg-gray-800 rounded-3xl p-6 mb-6">
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            className="w-full py-4 bg-gradient-to-r from-indigo-600 to-violet-600 text-white rounded-2xl font-bold text-lg shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/50 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                        >
                            {isLoading ? (
                                <>
