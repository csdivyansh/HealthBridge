...
const PatientPrescriptionsPage = () => {
    ...
    const generatePDF = async (prescriptionId) => {
        try {
            ...
            doc.setFont('helvetica', 'normal');
            doc.text('This is a digitally generated prescription from HealthBridge. Verify authenticity via QR code or prescription ID.', 15, footerY + 5);
            doc.text(`Generated: ${new Date().toLocaleString('en-IN')} | Status: ${data.status?.toUpperCase()}`, 15, footerY + 10);
            doc.text('HealthBridge - AI-Powered Healthcare | www.healthbridge.ai', 15, footerY + 15);
                                ...
                                <div className="p-5 flex items-center justify-between cursor-pointer" onClick={() => setExpandedId(expandedId === rx._id ? null : rx._id)}>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <button
                                            ...
                                            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl text-sm font-medium hover:from-blue-700 hover:to-indigo-700 transition disabled:opacity-50 shadow-sm"
                                        >
