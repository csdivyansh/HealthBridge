...
import { Stethoscope, Heart, Pill, Building2, Mail, Lock, ArrowRight, ArrowLeft, HeartPulse, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 via-violet-600 to-purple-700 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <h1 className="text-5xl font-bold text-white leading-tight mb-6">
            Welcome to the<br />
            <span className="text-indigo-200">Future of Healthcare</span>
          </h1>
          <p className="text-xl text-indigo-100 max-w-md leading-relaxed">
            Connect with top healthcare professionals, manage appointments, and take control of your health journey.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center justify-center gap-3 mb-8">
            <div className="w-11 h-11 bg-gradient-to-br from-indigo-600 to-violet-600 rounded-xl flex items-center justify-center shadow-lg shadow-indigo-500/30">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3.5 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all duration-300 bg-white"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full pl-12 pr-12 py-3.5 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all duration-300 bg-white"
            ...
            <Link
              ...
              className="w-full py-4 border-2 border-gray-200 text-gray-700 font-semibold rounded-xl transition-all duration-300 hover:border-indigo-300 hover:bg-indigo-50 flex items-center justify-center gap-2"
            >
            ...
            <Link
              to="/"
              className="w-full py-3 text-gray-500 font-medium transition-colors hover:text-indigo-600 flex items-center justify-center gap-2"
            >
