        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-6">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-violet-600 bg-clip-text text-transparent">Health Analytics</h1>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-8">
                    {[
                        { label: 'Total Visits', value: totalAppts, icon: Calendar, color: 'from-blue-500 to-indigo-600' },
                        ...
                        { label: 'Active Goals', value: activeGoals, icon: Target, color: 'from-violet-500 to-purple-600' },
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        <h3 className="font-bold text-gray-800 mb-4 flex items-center gap-2">
                            <BarChart3 className="w-5 h-5 text-indigo-500" /> Appointment Trend
                        </h3>
                            ...
                            {monthlyTrend.map((m, i) => (
                                <div key={i} className="flex-1 flex flex-col items-center gap-1">
                                    ...
                                    <div className="w-full bg-gray-100 rounded-t-lg relative overflow-hidden" style={{ height: '120px' }}>
                                        <div
                                            className="absolute bottom-0 w-full bg-gradient-to-t from-indigo-600 to-violet-500 rounded-t-lg transition-all duration-700"
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        <h3 className="font-bold text-gray-800 mb-4 flex items-center gap-2">
                            <Target className="w-5 h-5 text-violet-500" /> Health Goals
                        </h3>
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            <div className="text-center p-2 bg-violet-50 rounded-xl">
                                <p className="text-lg font-bold text-violet-600">{activeGoals}</p>
                            ...
                            <div className="text-center p-2 bg-indigo-50 rounded-xl">
                                <p className="text-lg font-bold text-indigo-600">{goalAnalytics?.bestStreak || 0}</p>
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        <h3 className="font-bold text-gray-800 mb-4 flex items-center gap-2">
                            <Moon className="w-5 h-5 text-indigo-500" /> Wellness Snapshot
                        </h3>
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        ...
                        {topSymptoms.length === 0 ? (
                            <div className="text-center p-6">
                                ...
                                <button onClick={() => navigate('/patient/symptom-journal')} className="mt-3 text-indigo-600 text-sm font-medium hover:underline">Start logging →</button>
                            </div>
                        ) : (
                        ...
                        {Object.keys(moodData).length === 0 ? (
                            ...
                            <div className="flex items-end gap-4 h-32 justify-center">
                                {Object.entries(moodData).map(([mood, count], i) => {
                                    ...
                                    const moodColors = { great: 'from-green-400 to-emerald-500', good: 'from-blue-400 to-indigo-500', okay: 'from-yellow-400 to-amber-500', bad: 'from-orange-400 to-red-500', terrible: 'from-red-400 to-rose-500' };
                                    return (
