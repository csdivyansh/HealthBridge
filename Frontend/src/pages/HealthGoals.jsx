        ...
        <div className="min-h-screen bg-gray-50/50 p-4 md:p-8">
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                <div className="bg-white rounded-2xl p-5 border border-gray-100">
                    ...
                    <p className="text-3xl font-black text-indigo-600">{stats.active || 0}</p>
                </div>
                <div className="bg-white rounded-2xl p-5 border border-gray-100">
                ...
                <div className="bg-white rounded-2xl p-5 border border-gray-100">
                    ...
                    <p className="text-3xl font-black text-purple-600">{analytics?.totalCheckins || 0}</p>
                </div>
            </div>
                        ...
                        {suggestions.map((suggestion, idx) => {
                            ...
                            return (
                                <button
                                    ...
                                    className="bg-white p-5 rounded-2xl border border-gray-100 text-left hover:shadow-lg hover:border-indigo-200 transition-all group"
                                >
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <ChevronRight className="w-4 h-4 text-gray-300 group-hover:text-indigo-600 transition" />
                                    </div>
                                </button>
                            );
                        })}
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-6 text-white">
                            ...
                            <div className="flex items-end gap-4">
                                ...
                                <span className="text-indigo-200 pb-2">
                        ...
                        <form onSubmit={handleCreateGoal} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full p-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 outline-none"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full p-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 outline-none resize-none"
                                    rows={2}
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-3 pt-2">
                                ...
                                <button
                                    ...
                                    className="flex-1 py-3 bg-indigo-600 text-white rounded-xl font-bold hover:bg-indigo-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
                                >
