...
import api, { getPatientAppointments } from '../services/api';
...
const MedicalHistory = () => {
    ...
    // Fetch Data - Using the same API as PatientDashboard for consistency
    useEffect(() => {
        const fetchHistory = async () => {
            try {
                // Use getPatientAppointments and filter for completed ones
                const res = await getPatientAppointments();
                const allAppointments = res.data || [];
                
                // Filter only completed appointments for medical history
