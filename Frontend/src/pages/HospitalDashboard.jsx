        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-rose-50/30 p-4 md:p-8">
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <header className="bg-gradient-to-r from-rose-600 via-pink-600 to-rose-700 text-white p-8 rounded-3xl shadow-xl shadow-rose-500/20 mb-8 relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold">{hospital?.name || 'Hospital Dashboard'}</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-lg hover:border-violet-100 transition-all duration-300">
                        <div className="flex items-center gap-4">
                ...
                <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-violet-600 to-purple-600 text-white rounded-xl font-semibold shadow-lg shadow-violet-500/20 hover:shadow-xl hover:shadow-violet-500/30 transition-all"
                        >
                    ...
                    {/* Add Pricing Form */}
                    {showPricingForm && (
                        <div className="bg-gradient-to-br from-violet-50 to-purple-50 p-6 rounded-2xl mb-8 border border-violet-100">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-violet-500 focus:ring-4 focus:ring-violet-500/10 transition-all outline-none bg-white"
                                    >
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-violet-500 focus:ring-4 focus:ring-violet-500/10 transition-all outline-none"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="mb-6">
                                ...
                                <textarea
                                    ...
                                    rows="2"
                                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-violet-500 focus:ring-4 focus:ring-violet-500/10 transition-all outline-none resize-none"
                                />
                            </div>

                            <button
                                onClick={handleAddPricing}
                                className="w-full py-3.5 bg-gradient-to-r from-violet-600 to-purple-600 text-white font-bold rounded-xl shadow-lg shadow-violet-500/20 hover:shadow-xl transition-all"
                            >
                                Add Service
                            </button>
                        </div>
                    ...
                    <div className="space-y-4">
                        {hospital?.pricing && hospital.pricing.length > 0 ? (
                            hospital.pricing.map((item, idx) => (
                                <div key={idx} className="flex items-start justify-between p-5 bg-gradient-to-r from-gray-50 to-violet-50/30 rounded-2xl border border-gray-100 hover:shadow-md hover:border-violet-100 transition-all duration-300 group">
                                    <div className="flex-1">
                                        <div className="flex items-center gap-2 mb-2">
                                            <span className="px-3 py-1 bg-gradient-to-r from-violet-600 to-purple-600 text-white text-xs rounded-full font-semibold">
                                                {item.serviceType}
                                            </span>
                                        </div>
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {order.items?.slice(0, 4).map((item, idx) => (
                                                        <span key={idx} className="px-3 py-1 bg-white rounded-lg text-sm text-gray-600 border">
                                                            {item.medicineId?.name || 'Medicine'} × {item.quantity}
                                                        </span>
                                                    ))}
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="flex gap-2">
                                                    <button
                                                        ...
                                                        className="px-4 py-2 text-indigo-600 hover:bg-indigo-50 rounded-xl font-medium text-sm transition-all flex items-center gap-1"
                                                    >
                ...
                {activeTab === 'ai-tools' && (
                    <div className="space-y-6">
                        <div>
                            <h2 className="text-2xl font-bold text-gray-900 flex items-center gap-2"><Sparkles className="w-6 h-6 text-rose-500" /> AI-Powered Hospital Tools</h2>
                            <p className="text-gray-500">Intelligent tools powered by Groq AI for hospital operations</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                                ...
                                <div className="p-4 space-y-3">
                                    ...
                                    <button onClick={handleForecastCapacity} disabled={aiLoading} className="w-full py-2.5 bg-gradient-to-r from-indigo-500 to-blue-600 text-white rounded-xl font-bold text-sm disabled:opacity-50 flex items-center justify-center gap-2">
