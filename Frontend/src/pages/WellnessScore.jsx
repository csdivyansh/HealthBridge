    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-violet-50 via-purple-50 to-fuchsia-50">
            <div className="bg-white/80 backdrop-blur-xl border-b border-gray-200/50 sticky top-0 z-30">
                <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold bg-gradient-to-r from-purple-700 to-fuchsia-600 bg-clip-text text-transparent">
                                AI Wellness Score
                            </h1>
                            <p className="text-sm text-gray-500">Comprehensive health assessment powered by AI</p>
                        </div>
                    </div>
                    <button onClick={fetchScore} className="p-2.5 bg-purple-50 hover:bg-purple-100 rounded-xl transition">
            ...
            <div className="max-w-5xl mx-auto px-6 py-8 space-y-6">
                {/* Main Score Card */}
                <div className="bg-gradient-to-br from-purple-600 via-purple-700 to-fuchsia-700 rounded-3xl p-8 text-white shadow-2xl shadow-purple-300/30 relative overflow-hidden">
                    ...
                    <div className="relative flex items-center justify-between">
                        <div>
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-purple-200 text-sm font-medium">Overall Wellness</span>
                            </div>
                            <h2 className="text-5xl font-black mb-2">{score}<span className="text-2xl text-purple-200">/100</span></h2>
                            <p className="text-lg font-medium text-purple-100">{colors.label}</p>
                            <div className="flex items-center gap-2 mt-3">
                                {trendIcon(data?.trend)}
                                <span className="capitalize text-sm text-purple-200">{data?.trend || 'stable'} trend</span>
                            </div>
                        </div>
                ...
                {data?.personalizedTips?.length > 0 && (
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                        <h3 className="font-bold text-gray-800 mb-4 flex items-center gap-2 text-lg">
                            <Sparkles className="w-5 h-5 text-purple-500" /> AI Personalized Tips
                        </h3>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            {data.personalizedTips.map((tip, i) => (
                                <div key={i} className="bg-gradient-to-br from-purple-50 to-fuchsia-50 p-4 rounded-xl border border-purple-100">
                ...
                {data?.weeklyChallenge && (
                    <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl p-6 text-white shadow-lg">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-indigo-100 text-xs font-bold uppercase tracking-wider">This Week's Challenge</p>
