...
const AIHealthAssistant = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-indigo-50/30 p-6 md:p-10">
            {/* Header */}
            <header className="max-w-7xl mx-auto mb-8">
                <div className="bg-white/80 backdrop-blur-xl p-6 shadow-xl shadow-indigo-500/5 rounded-2xl border border-gray-100">
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br from-indigo-500 to-violet-500 rounded-xl shadow-lg shadow-indigo-500/30">
                            <Brain className="h-7 w-7 text-white" />
                        </div>
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900">AI Health Assistant</h1>
                            <p className="text-gray-500 text-sm">Powered by HealthBridge Intelligence</p>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <main className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
                {/* Chat Section */}
                <div className="lg:col-span-2 bg-white rounded-2xl shadow-xl shadow-indigo-500/5 overflow-hidden flex flex-col h-[600px] border border-gray-100">
                    <div className="bg-gradient-to-r from-indigo-600 via-violet-600 to-purple-600 p-5 text-white flex justify-between items-center relative overflow-hidden">
                    ...
                    <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-gray-50/50">
                        {messages.length === 0 ? (
                            <div className="flex flex-col items-center justify-center h-full text-center text-gray-400 space-y-4">
                                <div className="w-20 h-20 bg-gradient-to-br from-indigo-50 to-violet-50 rounded-2xl flex items-center justify-center">
                    ...
                    <div className="p-4 bg-white border-t border-gray-100">
                        <div className="flex gap-3">
                            <input
                                ...
                                className="flex-1 px-5 py-3.5 border-2 border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all"
                                disabled={loading}
                            />
                            <button
                                onClick={handleAIQuery}
                                disabled={loading || !prompt.trim()}
                                className="px-6 py-3.5 bg-gradient-to-r from-indigo-600 to-violet-600 text-white rounded-xl hover:shadow-xl hover:shadow-indigo-500/30 transition-all disabled:opacity-50 flex items-center gap-2 font-bold shadow-lg shadow-indigo-500/20"
                            >
                ...
                <div className="space-y-6">
                    <div className="bg-white rounded-2xl shadow-xl shadow-indigo-500/5 p-6 border border-gray-100">
                        <h2 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                            <MapPin className="text-indigo-600" /> Find Nearby
                        </h2>
                    ...
                    <div className="bg-white rounded-2xl shadow-xl shadow-indigo-500/5 overflow-hidden h-64 relative border border-gray-100">
