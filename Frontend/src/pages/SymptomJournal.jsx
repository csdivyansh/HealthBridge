...
const MOODS = [
    ...
    { value: 'poor', label: '😔 Poor', color: 'bg-orange-100 text-orange-700 border-orange-200' },
    { value: 'terrible', label: '😫 Terrible', color: 'bg-red-100 text-red-700 border-red-200' }
];
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 animate-in slide-in-from-bottom-4">
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                            ...
                            <div className="flex flex-wrap gap-2 mb-4">
                                {COMMON_SYMPTOMS.slice(0, 8).map(symptom => (
                                    <button
                                        ...
                                        className="px-3 py-1 bg-gray-100 text-gray-600 text-sm rounded-full hover:bg-indigo-100 hover:text-indigo-700 transition"
                                    >
                                        {symptom}
                                    </button>
                                ))}
                            ...
                            <div className="flex gap-3 mb-4">
                                <input
                                    ...
                                    className="flex-1 px-4 py-2 bg-gray-50 rounded-xl border-none focus:ring-2 focus:ring-indigo-200 outline-none"
                                />
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-3 bg-gray-50 rounded-xl border-none focus:ring-2 focus:ring-indigo-200"
                                            placeholder="Hours"
                                        />
                                    </div>
                                    <div>
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                            ...
                            <textarea
                                ...
                                className="w-full px-4 py-3 bg-gray-50 rounded-xl border-none focus:ring-2 focus:ring-indigo-200 resize-none"
                            />
                        </div>
                        ...
                        <button
                            ...
                            className="w-full bg-indigo-600 text-white py-4 rounded-2xl font-bold text-lg hover:bg-indigo-700 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg shadow-indigo-200"
                        >
                        ...
                        {loading ? (
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div className="bg-white rounded-2xl p-6 shadow-sm">
                                    <h3 className="font-bold text-gray-800 mb-4 flex items-center gap-2">
                                        <TrendingUp className="w-5 h-5 text-indigo-500" /> Most Common Symptoms
                                    </h3>
                                ...
                                <div className="bg-white rounded-2xl p-6 shadow-sm">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="bg-indigo-50 p-4 rounded-xl text-center">
                                            <p className="text-3xl font-bold text-indigo-600">{trends.totalEntries}</p>
                                            <p className="text-sm text-indigo-500">Total Entries</p>
                                        </div>
