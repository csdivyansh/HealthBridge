        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-amber-50/30">
            ...
            <aside className="fixed left-0 top-0 h-full w-64 bg-white border-r border-gray-200 shadow-xl z-40 hidden lg:block">
                <div className="p-6 border-b border-gray-100">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="font-bold text-gray-900">HealthBridge</h1>
            ...
            <main className="lg:ml-64 pt-32 lg:pt-0 p-6 lg:p-8">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-gray-500">Welcome back, {pharmacy?.name}</p>
                            </div>
                ...
                {activeTab === 'ai-tools' && (
                    <div className="space-y-6">
                        <div>
                            <h2 className="text-2xl font-bold text-gray-900 flex items-center gap-2"><Sparkles className="w-6 h-6 text-purple-500" /> AI-Powered Pharmacy Tools</h2>
                            <p className="text-gray-500">Smart tools powered by Groq AI to optimize your pharmacy</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                                ...
                                <div className="p-5 space-y-3">
                                    <input type="text" placeholder="Drug name (e.g. Atorvastatin)" value={drugAltForm.drugName} onChange={e => setDrugAltForm({...drugAltForm, drugName: e.target.value})} className="w-full p-3 border rounded-xl outline-none focus:ring-2 focus:ring-purple-200" />
                                    ...
                                    <button onClick={handleDrugAlternatives} disabled={aiLoading || !drugAltForm.drugName} className="w-full py-3 bg-gradient-to-r from-violet-500 to-purple-600 text-white rounded-xl font-bold disabled:opacity-50 flex items-center justify-center gap-2">
                                        {aiLoading && !reorderResult ? <><Loader2 className="w-5 h-5 animate-spin" /> Searching...</> : <><Sparkles className="w-5 h-5" /> Find Alternatives</>}
                                    </button>
                                    {drugAltResult && (
                                        <div className="mt-3 bg-purple-50 rounded-xl p-4 border border-purple-100 text-sm text-gray-700 whitespace-pre-wrap max-h-72 overflow-y-auto">
                                            {drugAltResult}
                                            <div className="flex gap-2 mt-3">
                                                ...
                                                <button onClick={() => setDrugAltResult(null)} className="text-xs text-purple-600 font-medium hover:underline">Clear</button>
                                            </div>
                                        </div>
                                    )}
                                </div>
                            ...
                            <div className="bg-purple-50 rounded-xl p-4 mb-6">
                                ...
                                {selectedBulkOrder.hospitalContact && (
                                    <div className="grid grid-cols-2 gap-2 text-sm text-gray-600">
                                        {selectedBulkOrder.hospitalContact.phone && <p>📞 {selectedBulkOrder.hospitalContact.phone}</p>}
                                        {selectedBulkOrder.hospitalContact.email && <p>✉️ {selectedBulkOrder.hospitalContact.email}</p>}
                                        {selectedBulkOrder.hospitalContact.address && <p className="col-span-2">📍 {selectedBulkOrder.hospitalContact.address}</p>}
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="flex flex-wrap gap-3 justify-end">
                                ...
                                {selectedBulkOrder.status === 'Processing' && (
                                    <button
                                        ...
                                        className="px-6 py-2 bg-indigo-500 text-white rounded-lg hover:bg-indigo-600 font-medium flex items-center gap-2"
                                    >
