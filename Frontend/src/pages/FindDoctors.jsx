...
const FindDoctors = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-indigo-50/30 p-6 md:p-10 relative">
            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                    ...
                    <div className="flex flex-col md:flex-row gap-3 w-full md:w-auto">
                        <div className="relative">
                            ...
                            <select 
                                ...
                                className="pl-10 pr-4 py-3.5 rounded-xl border-2 border-gray-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 bg-white text-gray-700 w-full md:w-48 appearance-none cursor-pointer transition-all"
                            >
                        ...
                        <div className="relative flex-1 flex gap-2">
                            <div className="relative flex-1">
                                ...
                                <input 
                                    ...
                                    className="pl-10 pr-4 py-3.5 rounded-xl border-2 border-gray-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 w-full transition-all"
                                />
                            </div>
                            {/* AI BUTTON */}
                            <button 
                                ...
                                className="bg-gradient-to-r from-indigo-600 to-violet-600 text-white px-5 rounded-xl shadow-lg shadow-indigo-500/20 font-bold text-xs flex items-center gap-2 hover:shadow-xl hover:shadow-indigo-500/30 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                {loading ? (
                    <div className="text-center py-20">
                        <div className="w-20 h-20 bg-gradient-to-br from-indigo-50 to-violet-50 rounded-2xl flex items-center justify-center mx-auto mb-6 animate-pulse">
                        ...
                        {doctors.map((doctor) => (
                            <div key={doctor._id} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl hover:border-gray-200 hover:-translate-y-1 transition-all duration-300 flex flex-col group">
                                    ...
                                    <div className="flex items-center space-x-4">
                                        <div className="relative">
                                            <img 
                                                ...
                                                alt={doctor.name} 
                                                className="w-16 h-16 rounded-xl border-2 border-indigo-100 object-cover group-hover:border-indigo-200 transition-colors"
                                            />
                                        ...
                                        <div>
                                            <h3 className="text-lg font-bold text-gray-900 group-hover:text-indigo-600 transition-colors">Dr. {doctor.name}</h3>
                                ...
                                <button
                                    ...
                                    className="w-full py-3.5 px-6 rounded-xl font-bold text-white bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700 shadow-lg shadow-indigo-500/20 hover:shadow-xl hover:shadow-indigo-500/30 transition-all transform active:scale-95 flex items-center justify-center space-x-2 mt-auto"
                                >
