        ...
        <div className="min-h-screen bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-50">
            ...
            <div className="max-w-5xl mx-auto px-6 py-8">
                ...
                <button onClick={handleTranslate} disabled={loading || !text.trim()}
                    className="w-full mt-6 py-3.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-bold text-sm
                        hover:from-blue-700 hover:to-indigo-700 transition disabled:opacity-50 flex items-center justify-center gap-2 shadow-lg shadow-blue-200">
