                            ...
                            <div className="grid md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-3 bg-white rounded-xl border border-gray-200 focus:ring-2 focus:ring-indigo-200 outline-none"
                            ...
                            {contacts.map(contact => (
                                <div
                                    ...
                                    className={`flex items-center justify-between p-4 rounded-xl border-2 transition ${
                                        contact.isPrimary ? 'border-indigo-200 bg-indigo-50' : 'border-gray-100 bg-gray-50'
                                    }`}
                                >
                                    <div className="flex items-center gap-4">
                                        <div className={`w-12 h-12 rounded-xl flex items-center justify-center text-white font-bold ${
                                            contact.isPrimary ? 'bg-indigo-600' : 'bg-gray-400'
                                        }`}>
                                        ...
                                        <div>
                                            <div className="flex items-center gap-2">
                                                ...
                                                {contact.isPrimary && (
                                                    <span className="px-2 py-0.5 bg-indigo-100 text-indigo-700 text-xs font-bold rounded-full">PRIMARY</span>
                                                )}
                                            </div>
