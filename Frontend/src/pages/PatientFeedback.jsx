                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
                        ...
                        <div className="bg-gradient-to-r from-indigo-600 to-violet-600 p-6 text-white">
                            ...
                            <p className="text-indigo-200 mt-1">With Dr. {selectedAppt.doctorId?.name} — {new Date(selectedAppt.date).toLocaleDateString()}</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-8">
                            ...
                            <div>
                                ...
                                <textarea value={comments} onChange={(e) => setComments(e.target.value)} rows={3}
                                    className="w-full border border-gray-200 rounded-xl p-3 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent resize-none"
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <h1 className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-violet-600 bg-clip-text text-transparent">Patient Feedback</h1>
                ...
                <div className="flex gap-2 mb-6">
                    {[{ key: 'pending', label: 'Pending', count: pending.length }, { key: 'submitted', label: 'Submitted', count: submitted.length }].map(t => (
                        <button key={t.key} onClick={() => setTab(t.key)}
                            className={`px-5 py-2.5 rounded-xl font-medium text-sm transition-all ${tab === t.key ? 'bg-indigo-600 text-white shadow-lg' : 'bg-white text-gray-600 hover:bg-gray-50 border'}`}>
                            ...
                            {pending.map(appt => (
                                <div key={appt._id} className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 hover:shadow-md transition-all flex items-center justify-between">
                                    ...
                                    <button onClick={() => setSelectedAppt(appt)}
                                        className="px-5 py-2.5 bg-gradient-to-r from-indigo-600 to-violet-600 text-white font-medium rounded-xl hover:from-indigo-700 hover:to-violet-700 transition-all shadow text-sm flex items-center gap-2">
                                ...
                                <div key={fb._id} className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                                    ...
                                    {fb.doctorResponse && (
                                        <div className="mt-3 p-3 bg-indigo-50 rounded-xl">
                                            <p className="text-xs font-semibold text-indigo-600 mb-1">Doctor's Response</p>
