 ...
 * Unified Stream.io Chat + Video solution for HealthBridge
...
const CustomChannelHeader = ({ partner, onStartCall, isLoadingCall }) => {
    ...
    return (
        <div className="stream-header px-6 py-4 bg-gradient-to-r from-indigo-600 via-violet-600 to-purple-600 flex justify-between items-center relative overflow-hidden">
            {/* Background pattern */}
                ...
                <StreamCall call={call}>
                    {!isJoined ? (
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800 text-white">
                            <div className="w-24 h-24 bg-gradient-to-br from-indigo-500 to-violet-600 rounded-full flex items-center justify-center mb-6 shadow-2xl">
    ...
    if (isLoading) {
        return (
            <div className="flex flex-col h-full bg-white rounded-3xl shadow-xl border border-gray-100 items-center justify-center">
                <div className="w-16 h-16 bg-gradient-to-br from-indigo-500 to-violet-600 rounded-2xl flex items-center justify-center mb-4 animate-pulse">
        ...
        return (
            <div className="flex flex-col h-full bg-white rounded-3xl shadow-xl border border-gray-100 items-center justify-center p-8">
                ...
                <button
                    ...
                    className="px-6 py-2 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition-all font-medium"
                >
                    Retry
                </button>
            </div>
