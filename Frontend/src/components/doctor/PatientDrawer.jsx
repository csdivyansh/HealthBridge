            ...
            <div className="fixed inset-y-0 right-0 w-[420px] bg-white shadow-2xl z-50 animate-in slide-in-from-right duration-300 flex flex-col">
                ...
                <div className="bg-gradient-to-r from-purple-600 to-indigo-600 p-6 text-white shrink-0">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-purple-200 text-sm flex items-center gap-1 truncate">
                ...
                <div className="grid grid-cols-3 gap-3 p-5 border-b border-gray-100 shrink-0">
                    <div className="bg-indigo-50 rounded-xl p-4 text-center">
                        ...
                        <p className="text-2xl font-black text-indigo-600">{patientAppointments.length}</p>
                        <p className="text-[10px] text-indigo-400 uppercase tracking-wider font-bold">Total Visits</p>
                    </div>
