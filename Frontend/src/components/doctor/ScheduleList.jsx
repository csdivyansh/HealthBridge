                        ...
                        return (
                            <div 
                                ...
                                className={`bg-white rounded-xl border transition-all duration-200 group ${
                                    isExpanded ? 'border-indigo-200 shadow-lg' : 'border-gray-100 hover:border-gray-200 hover:shadow-md'
                                }`}
                            >
                                {/* Main Row */}
                                <div className="flex items-center p-4 gap-4">
                                    ...
                                    <div className="flex items-center gap-3 flex-1 min-w-0">
                                        <div className="relative shrink-0">
                                            <div className="w-11 h-11 bg-gradient-to-br from-indigo-100 to-violet-100 rounded-xl flex items-center justify-center text-indigo-600 font-bold text-lg">
                                                {patient?.name?.[0] || '?'}
                                            </div>
                                    ...
                                    {apt.status !== 'completed' && apt.status !== 'cancelled' && (
                                        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                            ...
                                            <button 
                                                ...
                                                className="px-4 py-2 bg-indigo-600 text-white rounded-lg text-xs font-bold hover:bg-indigo-700 transition flex items-center gap-1"
                                            >
