        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div className="flex flex-wrap gap-2">
                    {prescriptionTemplates.slice(0, 6).map((template, idx) => (
                        <button 
                            ...
                            className="px-3 py-1.5 bg-indigo-50 text-indigo-700 rounded-lg text-xs font-bold hover:bg-indigo-100 transition-colors border border-indigo-100 flex items-center gap-1"
                        >
                            <span className="text-indigo-400 font-mono">{template.command}</span>
            ...
            <div className="relative">
                ...
                <textarea 
                    ...
                    className="w-full p-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none font-mono text-sm resize-none"
                    ...
                    <div className="absolute bottom-full left-0 right-0 mb-2 bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden z-10 animate-in fade-in slide-in-from-bottom-2 duration-150">
                        <div className="p-2 border-b border-gray-100 bg-gray-50">
                            <p className="text-xs text-gray-500 font-medium flex items-center gap-1">
                                ...
                                <span className="text-gray-400 ml-auto">↑↓ Navigate • Enter Select</span>
                            </p>
                        </div>
            ...
            <div className="flex gap-3 pt-4">
                ...
                <button 
                    type="submit"
                    className="flex-1 py-3 bg-indigo-600 text-white rounded-xl font-bold hover:bg-indigo-700 transition flex items-center justify-center gap-2 shadow-lg shadow-indigo-200"
                >
