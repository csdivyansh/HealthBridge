                ...
                <div className="bg-gradient-to-r from-indigo-600 to-violet-600 px-6 py-4 flex justify-between items-center shrink-0">
                    ...
                    <div className="flex items-center gap-2">
                        <button 
                            ...
                            className="px-4 py-2 bg-white text-indigo-600 rounded-lg font-bold text-sm hover:bg-indigo-50 transition flex items-center gap-2"
                        >
                ...
                <div className="flex-1 overflow-y-auto">
                            ...
                            <div className="bg-gray-50 rounded-xl p-4">
                                ...
                                <div className="space-y-2 text-sm">
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-bold text-indigo-600">{patientHistory.length}</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    {activeTab === 'ai' && (
                        <div className="p-5">
                            ...
                            <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl p-4 border border-purple-100 min-h-[200px]">
                                {aiLoading ? (
                                    <div className="flex flex-col items-center justify-center h-40">
                                        <Loader2 className="w-8 h-8 text-purple-600 animate-spin mb-2"/>
                                        <p className="text-sm text-purple-400">Analyzing conversation...</p>
                                    </div>
                                ) : aiSummary ? (
                                    ...
                                    <div className="flex flex-col items-center justify-center h-40 text-center">
                                        <Brain className="w-10 h-10 text-purple-200 mb-3" />
