...
const UpNextCard = ({ nextPatient, onStartVideo, onViewPatient, appointments }) => {
    ...
    return (
        <div className="bg-gradient-to-br from-indigo-600 via-violet-600 to-purple-700 rounded-2xl p-6 text-white shadow-2xl shadow-indigo-500/30 relative overflow-hidden">
            {/* Decorative Elements */}
            ...
            <div className="relative z-10">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-bold text-indigo-200 uppercase tracking-wider">Up Next</span>
                    </div>
                    {isReturning && (
                ...
                <div className="flex items-start justify-between gap-6">
                    <div className="flex items-center gap-5">
                        ...
                        <div>
                            ...
                            {nextPatient.reason && (
                                <p className="mt-2 text-sm text-indigo-200 bg-white/10 px-3 py-1 rounded-lg inline-block">
                ...
                <div className="flex items-center gap-3 mt-6">
                    <button 
                        ...
                        className="flex-1 bg-white text-indigo-600 px-6 py-3.5 rounded-xl font-bold text-sm hover:bg-indigo-50 transition-all shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2"
                    >
