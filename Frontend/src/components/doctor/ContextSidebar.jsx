    ...
    return (
        <aside className="w-80 bg-white border-l border-gray-100 flex flex-col h-full overflow-hidden">
            ...
            <div className="p-5 border-b border-gray-100 grid grid-cols-2 gap-3">
                <div className="bg-gradient-to-br from-indigo-50 to-violet-50 p-3 rounded-xl text-center">
                        ...
                        return date ? (
                            <button 
                                ...
                                className={`
                                    ...
                                    ${isSelected ? 'bg-indigo-600 text-white shadow-md' : isToday ? 'bg-indigo-50 text-indigo-600 font-bold' : 'hover:bg-gray-100 text-gray-600'}
                                `}
                            >
                                {date.getDate()}
                            ...
                            <div key={i} className="flex-1 flex flex-col items-center group">
                                <div 
                                    className={`w-full rounded-t transition-all ${
                                        item.count > 0 
                                            ? 'bg-gradient-to-t from-indigo-500 to-violet-400 group-hover:from-indigo-600 group-hover:to-violet-500' 
                                            : 'bg-gray-100'
                                    }`}
                                    style={{ height: `${height}%` }}
                                />
