    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-md animate-fadeIn">
            <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] border border-gray-100">
                ...
                {/* Header */}
                <div className="bg-gradient-to-r from-indigo-600 via-violet-600 to-purple-600 p-6 flex justify-between items-center text-white shrink-0 relative overflow-hidden">
                    <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.05)_1px,transparent_1px)] bg-[size:20px_20px]"></div>
                    <div className="relative z-10">
                        <h2 className="text-xl font-bold">Book Appointment</h2>
                        <p className="text-indigo-200 text-sm">with Dr. {doctor.name}</p>
                    </div>
                ...
                <div className="p-6 overflow-y-auto flex-1">
                    ...
                    {step === 1 && (
                        <div className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <input 
                                    type="date" 
                                    className="w-full p-3.5 border-2 border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all"
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-gray-700 flex items-center gap-2">
                                    ...
                                    Select Time Slot
                                    {loadingSlots && <Loader2 className="h-3 w-3 animate-spin ml-2 text-indigo-500"/>}
                                </label>
                                                ...
                                                <button
                                                    ...
                                                    className={`
                                                        ...
                                                        ${isTaken 
                                                            ...
                                                            : isSelected 
                                                                ? 'bg-gradient-to-r from-indigo-600 to-violet-600 text-white border-transparent shadow-lg shadow-indigo-500/30 scale-105' 
                            ...
                            <div className="pt-4 border-t border-gray-100 flex justify-between items-center">
                                ...
                                <button 
                                    ...
                                    className="bg-gradient-to-r from-indigo-600 to-violet-600 text-white py-3.5 px-6 rounded-xl font-bold hover:shadow-xl hover:shadow-indigo-500/30 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                                >
                    ...
                    {step === 3 && (
                        <div className="text-center py-8 animate-in zoom-in duration-300">
                             ...
                             <button 
                                 onClick={onClose}
                                 className="w-full bg-gradient-to-r from-indigo-600 to-violet-600 text-white py-3.5 rounded-xl font-bold hover:shadow-xl hover:shadow-indigo-500/30 transition-all"
                             >
                                 Done
                             </button>
                        </div>
