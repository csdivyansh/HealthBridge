                ...
                <div className="absolute right-0 top-full mt-2 w-96 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden z-50 animate-in slide-in-from-top-2">
                    ...
                    <div className="px-5 py-4 bg-white border-b border-gray-200 flex items-center justify-between rounded-t-2xl">
                        ...
                        <div className="flex items-center gap-2">
                            {unreadCount > 0 && (
                                <button onClick={handleMarkAllRead} className="text-indigo-500 hover:text-indigo-700 text-xs flex items-center gap-1 transition" title="Mark all as read">
                            ...
                            notifications.map((notif) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full text-left px-5 py-3.5 border-b border-gray-50 hover:bg-gray-50 transition-all flex items-start gap-3 ${!notif.isRead ? 'bg-indigo-50/50' : ''}`}
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center justify-between">
                                                ...
                                                {!notif.isRead && (
                                                    <span className="w-2.5 h-2.5 bg-indigo-500 rounded-full shrink-0 ml-2"></span>
                                                )}
                                            </div>
